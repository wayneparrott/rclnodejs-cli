...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\rclnodejs_pkg_creation_tool\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\rclnodejs_pkg_creation_tool\hook\ament_prefix_path.bat"
